...
const myInformation = ['Anna', '27', 'December', 'Capricorn'];
...
const lastCity = countries.length - 1;
console.log(countries[lastCity]);
...
const countriesFirst = countries.shift();
...
let cities = ['Санкт-Петербург', 'Москва', 'Екатеринбург', ...russianCities];
console.log(cities);
...
const sortAndPrint = () => {
    const copyRandomNumbers = [...randomNumbers];
    copyRandomNumbers.sort(function (a, b) {
        return a - b;
    });
